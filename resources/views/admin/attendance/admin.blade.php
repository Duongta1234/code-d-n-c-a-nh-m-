                ...
                <div class="row filter-row">
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="input-block mb-3 form-focus select-focus mb-0">
                            ...
                            <label class="focus-label">Theo tháng</label>
                        </div>
                    </div>
                    {{-- <div class="col-sm-6 col-md-3">
                            <div class="input-block mb-3 form-focus select-focus mb-0">
                                        ...
                                        @for ($i = 1; $i <= 31; $i++)
                                            <td>
                                                @foreach ($employee->attendance as $attendance)
                                                    @if ($attendance->log_date->format('j') == $i)
                                                        @if ($attendance->status == 1 && auth()->user()->can('view-attendance'))
                                                        ...
                                                        @elseif ($attendance->status == 0 && auth()->user()->can('view-attendance'))
                                                            <a href="javascript:void(0);"
                                                               data-bs-toggle="modal"
                                                               data-bs-target="#attendance_info"
                                                               data-attendance="{{$attendance->id}}"
                                                        ...
                                                        @else
                                                            <!-- Show the attendance status without a link or button -->
